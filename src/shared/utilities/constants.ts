...
export const UIGridLayoutProps = getkeys<InstanceAttributes<UIGridLayout>>();
export const UIListLayoutProps = getkeys<InstanceAttributes<UIListLayout>>();
export const UIPaddingProps = getkeys<InstanceAttributes<UIPadding>>();
export const TextLabelProps = getkeys<InstanceAttributes<TextLabel>>();
